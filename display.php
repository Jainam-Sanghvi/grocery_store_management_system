...
<h2 style="color:snow;text-align:center;margin:25px;">USER SHOP DATA</h2>
...
<table class="table table-bordered" style="color:snow;color:#666;border:1px solid black;font-size:20px;font-weight:500;">
    ...
    <tbody id="myTable">
        ...
        <tr>
            ...
            <td><?php echo $r['qun'];?></td>
            <td><a href="shopdelete.php?REMOVE=<?php echo $r['id']; ?>" class="btn-danger btn-lg" onclick="return confirm('remove item from cart?');">REMOVE</a>
